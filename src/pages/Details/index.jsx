...
import { Container, ProfileSection, Tags, Text, Title } from './styles';
  ...
  return (
    <Container>
      ...
      <main>
        ...
        <ProfileSection>
          <img
            src="http://github.com/IagoLeal1.png"
            alt="Foto do Usuário"
          />
          <span>por Iago Leal</span>
        ...
        <Text>
          <p>
            ...
            enorme estação espacial. A partida de Cooper devasta Murphy.<br></br><br></br> Além de
